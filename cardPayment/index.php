    ...
    <div class="col-md-8">
        <div class="authincation-content">
            <div class="row no-gutters">
                <div class="col-xl-12">
                    <div class="auth-form">
                        <h3 class="text-center mb-4"><b>Merchant Transfer or Card Deposit</b></h3>
                        <form class="form-horizontal" enctype="multipart-formdata" method="post" action="#">
                            ...
                            <div class="row mb-4 hidden cardFiled">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control " name="card_number" id="card_number" placeholder="Card number" maxlength='16' value="4000002760003184">
                                </div>
                            </div>
                            <div class="row mb-4 hidden cardFiled">
